...
public class GoogleDriveConnectionNodeFactory extends NodeFactory<GoogleDriveConnectionNodeModel> implements NodeDialogFactory, KaiNodeInterfaceFactory {
    ...
    private static final List<PortDescription> INPUT_PORTS = List.of(
            fixedPort("Google Service Connection", """
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("Google Drive File System Connection", """
