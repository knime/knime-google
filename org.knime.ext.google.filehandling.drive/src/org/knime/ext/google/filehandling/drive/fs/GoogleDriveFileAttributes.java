 ...
 */
public class GoogleDriveFileAttributes extends BaseFileAttributes {
    private final FileMetadata m_file;
     ...
     */
    @Override
    public GoogleDrivePath fileKey() {
        return (GoogleDrivePath) super.fileKey();
    }
}
