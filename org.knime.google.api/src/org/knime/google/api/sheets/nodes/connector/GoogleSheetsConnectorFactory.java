...
public class GoogleSheetsConnectorFactory extends NodeFactory<GoogleSheetsConnectorModel> {
     ...
     */
    @Override
    public GoogleSheetsConnectorModel createNodeModel() {
        return new GoogleSheetsConnectorModel();
    }
     ...
     */
    @Override
    public NodeView<GoogleSheetsConnectorModel> createNodeView(final int viewIndex, final GoogleSheetsConnectorModel nodeModel) {
        return null;
    }
