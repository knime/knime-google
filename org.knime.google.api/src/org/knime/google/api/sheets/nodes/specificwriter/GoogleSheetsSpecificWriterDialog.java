 ...
 */
public class GoogleSheetsSpecificWriterDialog extends NodeDialogPane {

    private DialogComponentString m_spreadsheetName =
            new DialogComponentString(GoogleSheetsSpecificWriterModel.getSpreadsheetIdModel(), "Spreadsheet id:");

    private DialogComponentString m_sheetName =
            new DialogComponentString(GoogleSheetsSpecificWriterModel.getSheetnameModel(), "Sheet name:");

    private DialogComponentString m_range =
            new DialogComponentString(GoogleSheetsSpecificWriterModel.getRangeModel(), "Range:");

    private DialogComponentBoolean m_writeRaw =
            new DialogComponentBoolean(GoogleSheetsSpecificWriterModel.getWriteRawModel(), "Write raw");


    /**
     * Constructor creating the dialogs content.
     */
    public GoogleSheetsSpecificWriterDialog() {
