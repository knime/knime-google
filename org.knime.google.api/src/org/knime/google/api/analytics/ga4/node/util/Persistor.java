...
/**
 * Persistor interface for values that can be saved/loaded.
 *
...
public interface Persistor<T> {
     ...
     *
     * @param config config to load value from
     * @return loaded value
     * @throws InvalidSettingsException if the value could not be loaded
     */
     ...
     */
    void save(T obj, ConfigWO config);

    /**
     * Gets the model type ID.
