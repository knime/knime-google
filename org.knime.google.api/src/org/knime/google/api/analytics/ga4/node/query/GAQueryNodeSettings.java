...
final class GAQueryNodeSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "Metrics", description = """
            ...
            Metrics can be specified by name or defined by a mathematical expression. In the latter case the name
            field acts as the name for the newly defined metric.
            Available metric names can be seen in the <a href=" """ + ExternalLinks.API_LIST_METRIC + """
    ...
    @Widget(title = "Dimensions", description = """
            ...
            Available dimension names can be seen in the <a href=" """ + ExternalLinks.API_LIST_DIMENSION + """
    ...
    @Widget(title = "Output property quotas as flow variables",
        description = """
            ...
            + """
                    ...
                    <b>Note:</b> Retrieving a lot of data (many rows, many columns, or long date ranges) or specifying complex
                    filter criteria may be responsible for consumption of many tokens per node execution.
                    """,
        advanced = true)
    @Layout(OutputSection.class)
    @Persist(optional = true)
