...
public final class GAConnectionPortObjectSpec extends AbstractSimplePortObjectSpec {
    ...
    String getSummary() {
        ...
        if (m_property != null) {
            sb.append(String.format("Google Analytics 4 Property: %s%n", m_property.getPropertyId()));
        } else {
    ...
    public boolean equals(final Object other) {
        ...
        if (other instanceof GAConnectionPortObjectSpec) {
            final var otherSpec = (GAConnectionPortObjectSpec) other;
