...
import org.knime.database.node.connector.server.UnauthenticatedServerDBConnectorSettings;

/**
 * Settings model for the <em>Google BigQuery Connector</em> node.
 *
...
public class BigQueryDBConnectorSettings extends UnauthenticatedServerDBConnectorSettings {
     ...
     */
    public BigQueryDBConnectorSettings() {
        super("bigquery-connection");
        setDBType(BigQuery.DB_TYPE.getId());
