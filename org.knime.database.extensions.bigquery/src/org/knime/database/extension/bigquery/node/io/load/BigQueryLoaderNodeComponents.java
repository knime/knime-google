...
/**
 * Node dialog components and corresponding settings for {@link BigQueryLoaderNode}.
 *
 * @author Noemi Balassa
 */
public class BigQueryLoaderNodeComponents extends UnconnectedCsvLoaderNodeComponents {

    private static final ButtonGroupEnumInterface[] ELEMENTS_FILE_FORMAT_SELECTION = BigQueryLoaderFileFormat.values();
    ...
    /**
     * Constructs a {@link BigQueryLoaderNodeComponents} object.
     *
     * @param dialogDelegate the delegate of the node dialog to create components for.
     */
    public BigQueryLoaderNodeComponents(final DialogDelegate dialogDelegate) {
     ...
     */
    public BigQueryLoaderNodeComponents(final DialogDelegate dialogDelegate, final List<Charset> charsets) {
    ...
    protected DialogComponentButtonGroup
        ...
        return new DialogComponentButtonGroup(fileFormatSelectionModel, "File format", true,
            ELEMENTS_FILE_FORMAT_SELECTION);
    }
