...
/**
 * Supplier of all the default database attribute definitions for Google BigQuery.
 *
 * @author Noemi Balassa
 */
public class BigQueryDefaultAttributeSupplier extends DefaultAttributeSupplier {
